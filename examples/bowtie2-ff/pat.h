...
public:
	...
	Read * pbufa()  { return &buf1_;    } // MA
	Read * pbufb()  { return &buf2_;    } // MA
...
public:
		...
		bool& done)
	{
		...
		//std::cout << "BufferedFilePatternSource::nextReadImpl\n";
...
//						printf("time elapsed in BufferedFilePatternSource::nextReadImpl %f\n", elapsedTime);
		return success;
	}
