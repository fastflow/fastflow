...
/**
   submatches for a match.
   per-component submatches of a rule matching
*/
class SubMatchSet {
 public:
  /**
  ...
  */
  typedef map<PCompartment *, vector <SubMatchSet *> *> contentsType;
  ...
  */
  ...
  void add_content(PCompartment *co, SubMatchSet *content);
