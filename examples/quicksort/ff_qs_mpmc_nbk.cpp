 ...
 *
 * Non-blocking implementation of the Quicksort algorithm using MPMC. 
 *
 */
...
bool done        = false;
unsigned int   *A= NULL;
atomic_long_t      numtasks;
#if defined(SCALABLE_QUEUE)
multiMSqueue     * msq = NULL;
#else
MSqueue          * msq = NULL;
#endif
