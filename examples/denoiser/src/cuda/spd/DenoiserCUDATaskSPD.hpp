/*
 * DenoiserCUDATaskSPD.hpp
 *
 *  Created on: Feb 26, 2014
 *      Author: droccom
 */

#ifndef DENOISERCUDATASKSPD_HPP_
#define DENOISERCUDATASKSPD_HPP_
...
class DenoiserCUDATaskSPD: public baseCUDATask<unsigned int, float, unsigned char, unsigned char, int,
...
public:
	void setTask(void* t) {
		if (t) {
			...
			DenoiserKernelSPD_params *kparams = (DenoiserKernelSPD_params *)task_->kernel_params;
...
#endif /* DENOISERCUDATASKSPD_HPP_ */
