...
public:
  tpc_handle_t createBuffer(const void *key, tpc_dev_ctx_t *dev_ctx,
      tpc_device_alloc_flag_t flags, size_t size) {
  ...
  tpc_handle_t createBufferUnique(const void *key, tpc_dev_ctx_t *dev_ctx,
      tpc_device_alloc_flag_t flags, size_t size) {
  ...
  void updateKey(
      const void *oldkey, const void *newkey, tpc_dev_ctx_t *dev_ctx) {
  ...
  void releaseBuffer(
      const void *key, tpc_dev_ctx_t *dev_ctx, tpc_handle_t handle) {
    assert(allocated.find(dev_ctx) != allocated.end());
