...
#define FF_OCL_MAP_ELEMFUNC(name, basictype, param, idx, ...)                  \
  static char name[] =                                                         \
      "kern_" #name "|" #basictype "|" #basictype " f" #name "(" #basictype    \
      " " #param ",const int " #idx ") {\n" #__VA_ARGS__ ";\n}\n"              \
...
#define FF_OCL_MAP_ELEMFUNC_IO(name, outT, T, param, idx, ...)                 \
  static char name[] =                                                         \
      "kern_" #name "|" #outT "|" #outT " f" #name "(" #T " " #param           \
      ", const int " #idx ") {\n" #__VA_ARGS__ ";\n}\n"                        \
      "__kernel void kern_" #name "(\n"                                        \
      "\t__global " #T "* input,\n"                                            \
 ...
 * '...' is the OpenCL code of the elemental function
 */
#define FF_OCL_STENCIL_ELEMFUNC_2ENV(                                          \
    name, T, size, idx, in, env1T, env1, env2T, env2, ...)                     \
  static char name[] =                                                         \
      "kern_" #name "|" #T "|"                                                 \
      "\n\n" #T " f" #name "(\n"                                               \
      "\t__global " #T "* " #in ",\n"                                          \
      ...
      "\t    uint gridSize = get_local_size(0)*get_num_groups(0);\n"           \
      "\t    while(i < maxItems)  {\n"                                         \
      "\t        output[i+halo] = f" #name                                     \
      "(input+halo,inSize,ig,env1,env2);\n"                                    \
      "\t        i += gridSize;\n"                                             \
      "\t    }\n"                                                              \
      "}\n"
 ...
 * '...' is the OpenCL code of the elemental function
 */
#define FF_OCL_STENCIL_ELEMFUNC_2ENV_IO(                                       \
    name, T, outT, size, idx, in, env1T, env1, env2T, env2, ...)               \
  static char name[] =                                                         \
      "kern_" #name "|" #outT "|"                                              \
      "\n\n" #outT " f" #name "(\n"                                            \
      "\t__global " #T "* " #in ",\n"                                          \
...
#define FF_OCL_STENCIL_ELEMFUNC_1D(name, T, size, idx, ...)                    \
  static char name[] =                                                         \
      ...
      "\t    while(i < maxItems)  {\n"                                         \
      "\t        output[i+halo] = f" #name                                     \
      "(input+halo,inSize,i+offset,offset);\n"                                 \
      "\t        i += gridSize;\n"                                             \
      "\t    }\n"                                                              \
      "}\n"
...
#define FF_OCL_STENCIL_ELEMFUNC_1D_ENV(name, T, size, idx, env1T, ...)         \
  static char name[] =                                                         \
      ...
      "\t    while(i < maxItems)  {\n"                                         \
      "\t        output[i+halo] = f" #name                                     \
      "(input+halo,inSize,ig,offset,env);\n"                                   \
      "\t        i += gridSize;\n"                                             \
      "\t    }\n"                                                              \
      "}\n"
...
#define FF_OCL_STENCIL_ELEMFUNC_1D_2ENV(name, T, size, idx, env1T, env2T, ...) \
  static char name[] =                                                         \
      ...
      "\t    while(i < maxItems)  {\n"                                         \
      "\t        output[i+halo] = f" #name                                     \
      "(input+halo,inSize,ig,offset,env1,env2);\n"                             \
      "\t        i += gridSize;\n"                                             \
      "\t    }\n"                                                              \
      "}\n"
...
#define FF_OCL_STENCIL_ELEMFUNC_2D(name, T, height, width, row, col, ...)      \
  static char name[] =                                                         \
      ...
      "\t    while(i < maxItems)  {\n"                                         \
      "\t        output[i+halo] = f" #name                                     \
      "(input+halo,inHeight,inWidth,r,c,offset);\n"                            \
      "\t        i += gridSize;\n"                                             \
      "\t    }\n"                                                              \
      "}\n"
 ...
 * '...' is the OpenCL code of the elemental function
 */
#define FF_OCL_STENCIL_ELEMFUNC_2D_ENV(                                        \
    name, T, height, width, row, col, env1T, ...)                              \
  static char name[] =                                                         \
      "kern_" #name "|" #T "|"                                                 \
      "\n\n"                                                                   \
      "#define GET_IN(i,j) (in[((i)*" #width "+(j))-offset])\n"                \
      ...
      "\t    while(i < maxItems)  {\n"                                         \
      "\t        output[i+halo] = f" #name                                     \
      "(input+halo,inHeight,inWidth,r,c,offset,env);\n"                        \
      "\t        i += gridSize;\n"                                             \
      "\t    }\n"                                                              \
      "}\n"
 ...
 * '...' is the OpenCL code of the elemental function
 */
#define FF_OCL_STENCIL_ELEMFUNC_2D_2ENV(                                       \
    name, T, height, width, row, col, env1T, env2T, ...)                       \
  static char name[] =                                                         \
      "kern_" #name "|" #T "|"                                                 \
      "\n\n"                                                                   \
      "#define GET_IN(i,j) (in[((i)*" #width "+(j))-offset])\n"                \
      ...
      "\t    while(i < maxItems)  {\n"                                         \
      "\t        output[i+halo] = f" #name                                     \
      "(input+halo,inHeight,inWidth,r,c,offset,env1,env2);\n"                  \
      "\t        i += gridSize;\n"                                             \
      "\t    }\n"                                                              \
      "}\n"

#define FF_OCL_STENCIL_ELEMFUNC_2D_IO(                                         \
    name, T, outT, height, width, row, col, ...)                               \
  static char name[] =                                                         \
      "kern_" #name "|" #T "|"                                                 \
      "\n\n"                                                                   \
      "#define GET_IN(i,j) (in[((i)*" #width "+(j))-offset])\n" #outT          \
...
#define FF_OCL_REDUCE_COMBINATOR(name, basictype, param1, param2, ...)         \
  static char name[] =                                                         \
      "kern_" #name "|" #basictype "|" #basictype " f" #name "(" #basictype    \
      " " #param1 ",\n" #basictype " " #param2 ") {\n" #__VA_ARGS__ ";\n}\n"   \
      "__kernel void kern_" #name "(__global " #basictype                      \
      "* input, const uint halo, __global " #basictype                         \
      "* output, const uint n, __local " #basictype "* sdata, " #basictype     \
      " idElem) {\n"                                                           \
...
#define FFGENERICFUNC(name, basictype, ...)                                    \
  static char name[] = "kern_" #name "|" #basictype "|" #__VA_ARGS__ ";\n\n"
