...
template <typename Tin_, typename Tout_ = Tin_, typename Tenv1_ = char,
    typename Tenv2_ = char, typename Tenv3_ = char, typename Tenv4_ = char,
    typename Tenv5_ = char, typename Tenv6_ = char>
class baseCUDATask {
public:
  typedef Tin_ Tin;
  typedef Tout_ Tout;
  ...
  baseCUDATask()
      : inPtr(NULL), outPtr(NULL), env1Ptr(NULL), env2Ptr(NULL), env3Ptr(NULL),
        env4Ptr(NULL), env5Ptr(NULL), env6Ptr(NULL), inDevicePtr(NULL),
        outDevicePtr(NULL), env1DevicePtr(NULL), env2DevicePtr(NULL),
        env3DevicePtr(NULL), env4DevicePtr(NULL), env5DevicePtr(NULL),
        env6DevicePtr(NULL) {
    size_in = size_out = size_env1 = size_env2 = size_env3 = size_env4 =
        size_env5 = size_env6 = 0;
  }
  ...
  void setEnv1DevicePtr(Tenv1 *_env1DevicePtr) {
    env1DevicePtr = _env1DevicePtr;
  }
  void setEnv2DevicePtr(Tenv2 *_env2DevicePtr) {
    env2DevicePtr = _env2DevicePtr;
  }
  void setEnv3DevicePtr(Tenv3 *_env3DevicePtr) {
    env3DevicePtr = _env3DevicePtr;
  }
  void setEnv4DevicePtr(Tenv4 *_env4DevicePtr) {
    env4DevicePtr = _env4DevicePtr;
  }
  void setEnv5DevicePtr(Tenv5 *_env5DevicePtr) {
    env5DevicePtr = _env5DevicePtr;
  }
  void setEnv6DevicePtr(Tenv6 *_env6DevicePtr) {
    env6DevicePtr = _env6DevicePtr;
  }
...
protected:
  ...
  size_t size_in, size_out, size_env1, size_env2, size_env3, size_env4,
      size_env5, size_env6;
  Tout reduceVar;
};
...
#define FFMAPFUNC(name, T, param, code)                                        \
  struct name {                                                                \
    __device__ T K(T param, void *param1, void *param2, void *param3,          \
...
#define FFMAPFUNC2(name, outT, inT, param, code)                               \
  struct name {                                                                \
    __device__ outT K(inT param, void *param1, void *param2, void *param3,     \
        void *param4, void *param5, void *param6) {                            \
      code                                                                     \
    }                                                                          \
  }
...
#define FFMAPFUNC3(                                                            \
    name, outT, inT, param, env1T, param1, env2T, param2, env3T, param3, code) \
  struct name {                                                                \
    __device__ outT K(inT param, env1T *param1, env2T *param2, env3T *param3,  \
        void *dummy0, void *dummy1, void *dummy2) {                            \
      code                                                                     \
    }                                                                          \
  }

#define FFMAPFUNC4(name, outT, inT, param, env1T, param1, env2T, param2,       \
    env3T, param3, env4T, param4, code)                                        \
  struct name {                                                                \
    __device__ outT K(inT param, env1T *param1, env2T *param2, env3T *param3,  \
        env4T *param4, void *dummy0, void *dummy1) {                           \
      code                                                                     \
    }                                                                          \
  }

#define FFMAPFUNC5(name, outT, inT, param, env1T, param1, env2T, param2,       \
    env3T, param3, env4T, param4, env5T, param5, code)                         \
  struct name {                                                                \
    __device__ outT K(inT param, env1T *param1, env2T *param2, env3T *param3,  \
        env4T *param4, env5T *param5, void *dummy1) {                          \
      code                                                                     \
    }                                                                          \
  }

#define FFMAPFUNC6(name, outT, inT, param, env1T, param1, env2T, param2,       \
    env3T, param3, env4T, param4, env5T, param5, env6T, param6, code)          \
  struct name {                                                                \
    __device__ outT K(inT param, env1T *param1, env2T *param2, env3T *param3,  \
        env4T *param4, env5T *param5, env6T *param6) {                         \
      code                                                                     \
    }                                                                          \
  }
...
#define FFREDUCEFUNC(name, T, param1, param2, code)                            \
  struct device##name {                                                        \
    __device__ T K(                                                            \
        T param1, T param2, void *, void *, void *, void *, void *, void *) {  \
      code                                                                     \
    }                                                                          \
  };                                                                           \
  struct host##name {                                                          \
...
#define FFMAPCUDA(taskT, mapT) ff_mapCUDA<taskT, mapT>
...
#define NEWMAP(name, task_t, f, input, iter)                                   \
  ff_mapCUDA<task_t, f> *name = new ff_mapCUDA<task_t, f>(input, iter)
#define NEWMAPONSTREAM(task_t, f) new ff_mapCUDA<task_t, f>()
 ...
 *
 */
template <typename kernelF, typename Tin, typename Tout, typename Tenv1,
    typename Tenv2, typename Tenv3, typename Tenv4, typename Tenv5,
    typename Tenv6>
__global__ void mapCUDAKernel(kernelF K, Tin *input, Tout *output, Tenv1 *env1,
    Tenv2 *env2, Tenv3 *env3, Tenv4 *env4, Tenv5 *env5, Tenv6 *env6,
    size_t size) {
  unsigned int i = blockIdx.x * blockDim.x + threadIdx.x;
  unsigned int gridSize = blockDim.x * gridDim.x;
...
template <typename kernelF, typename T, typename Tenv1, typename Tenv2,
    typename Tenv3, typename Tenv4, typename Tenv5, typename Tenv6>
__global__ void reduceCUDAKernel(kernelF K, T *output, T *input, Tenv1 *env1,
    Tenv2 *env2, Tenv3 *env3, Tenv4 *env4, Tenv5 *env5, Tenv6 *env6,
  ...
  if (i < size) {
    ...
    if (nIsPow2 || i + blockSize < size)
      result =
          K.K(result, input[i + blockSize], env1, env2, env3, env4, env5, env6);
    i += gridSize;
  }
  ...
  if (blockSize >= 1024) {
    if (tid < 512) {
      sdata[tid] = result =
          K.K(result, sdata[tid + 512], env1, env2, env3, env4, env5, env6);
    }
    __syncthreads();
  }
  if (blockSize >= 512) {
    if (tid < 256) {
      sdata[tid] = result =
          K.K(result, sdata[tid + 256], env1, env2, env3, env4, env5, env6);
    }
    __syncthreads();
  }
  if (blockSize >= 256) {
    if (tid < 128) {
      sdata[tid] = result =
          K.K(result, sdata[tid + 128], env1, env2, env3, env4, env5, env6);
    }
    __syncthreads();
  }
  if (blockSize >= 128) {
    if (tid < 64) {
      sdata[tid] = result =
          K.K(result, sdata[tid + 64], env1, env2, env3, env4, env5, env6);
    }
    __syncthreads();
  }
  ...
  if (tid < 32) {
    ...
    if (blockSize >= 64) {
      smem[tid] = result =
          K.K(result, smem[tid + 32], env1, env2, env3, env4, env5, env6);
    }
    if (blockSize >= 32) {
      smem[tid] = result =
          K.K(result, smem[tid + 16], env1, env2, env3, env4, env5, env6);
    }
    if (blockSize >= 16) {
      smem[tid] = result =
          K.K(result, smem[tid + 8], env1, env2, env3, env4, env5, env6);
    }
    if (blockSize >= 8) {
      smem[tid] = result =
          K.K(result, smem[tid + 4], env1, env2, env3, env4, env5, env6);
    }
    if (blockSize >= 4) {
      smem[tid] = result =
          K.K(result, smem[tid + 2], env1, env2, env3, env4, env5, env6);
    }
    if (blockSize >= 2) {
      smem[tid] = result =
          K.K(result, smem[tid + 1], env1, env2, env3, env4, env5, env6);
    }
  }
...
template <typename taskT, typename TkernelMap, typename TkernelReduce,
    typename ThostReduce>
...
public:
  ...
  ff_stencilReduceCUDA(size_t maxIter_ = 1, Tout identityValue_ = Tout())
      : oneShot(NULL), identityValue(identityValue_), iter(0),
        maxIter(maxIter_) {
    maxThreads = maxBlocks = 0;
    oldSize_in = oldSize_out = oldSize_env1 = oldSize_env2 = oldSize_env3 =
        oldSize_env4 = oldSize_env5 = oldSize_env6 = 0;
    deviceID = -1;
    stream = NULL;
  ...
  ff_stencilReduceCUDA(
      const taskT &task, size_t maxIter_ = 1, Tout identityValue_ = Tout())
      : oneShot(&task), identityValue(identityValue_), iter(0),
        maxIter(maxIter_) {
    maxThreads = maxBlocks = 0;
    oldSize_in = oldSize_out = oldSize_env1 = oldSize_env2 = oldSize_env3 =
        oldSize_env4 = oldSize_env5 = oldSize_env6 = 0;
...
protected:
  ...
  inline void *svc(void *task) {
    ...
    size_t blockcnt_r = std::min(
        padded_size / thxblock_r + (padded_size % thxblock_r == 0 ? 0 : 1),
        maxBlocks);
    ...
    cudaMemcpyAsync(
        in_buffer, inPtr, Task.getBytesizeIn(), cudaMemcpyHostToDevice, stream);
    ...
    if (env1Ptr) {
      if (oldSize_env1 < Task.getBytesizeEnv1()) {
        ...
        if (cudaMalloc(&env1_buffer, Task.getBytesizeEnv1()) != cudaSuccess)
          error("mapCUDA error while allocating memory on device (env1 "
                "buffer)\n");
        oldSize_env1 = Task.getBytesizeEnv1();
      }
      Task.setEnv1DevicePtr(env1_buffer);
      cudaMemcpyAsync(env1_buffer, env1Ptr, Task.getBytesizeEnv1(),
    ...
    if (env2Ptr) {
      if (oldSize_env2 < Task.getBytesizeEnv2()) {
        ...
        if (cudaMalloc(&env2_buffer, Task.getBytesizeEnv2()) != cudaSuccess)
          error("mapCUDA error while allocating memory on device (env2 "
                "buffer)\n");
        oldSize_env2 = Task.getBytesizeEnv2();
      }
      Task.setEnv2DevicePtr(env2_buffer);
      cudaMemcpyAsync(env2_buffer, env2Ptr, Task.getBytesizeEnv2(),
          cudaMemcpyHostToDevice, stream);
    }
    //env3
    if (env3Ptr) {
      if (oldSize_env3 < Task.getBytesizeEnv3()) {
        ...
        if (cudaMalloc(&env3_buffer, Task.getBytesizeEnv3()) != cudaSuccess)
          error("mapCUDA error while allocating memory on device (env3 "
                "buffer)\n");
        oldSize_env3 = Task.getBytesizeEnv3();
      }
      Task.setEnv3DevicePtr(env3_buffer);
      cudaMemcpyAsync(env3_buffer, env3Ptr, Task.getBytesizeEnv3(),
          cudaMemcpyHostToDevice, stream);
    }
    //env4
    if (env4Ptr) {
      if (oldSize_env4 < Task.getBytesizeEnv4()) {
        ...
        if (cudaMalloc(&env4_buffer, Task.getBytesizeEnv4()) != cudaSuccess)
          error("mapCUDA error while allocating memory on device (env4 "
                "buffer)\n");
        oldSize_env4 = Task.getBytesizeEnv4();
      }
      Task.setEnv4DevicePtr(env4_buffer);
      cudaMemcpyAsync(env4_buffer, env4Ptr, Task.getBytesizeEnv4(),
          cudaMemcpyHostToDevice, stream);
    }
    //env5
    if (env5Ptr) {
      if (oldSize_env5 < Task.getBytesizeEnv5()) {
        ...
        if (cudaMalloc(&env5_buffer, Task.getBytesizeEnv5()) != cudaSuccess)
          error("mapCUDA error while allocating memory on device (env5 "
                "buffer)\n");
        oldSize_env5 = Task.getBytesizeEnv5();
      }
      Task.setEnv5DevicePtr(env5_buffer);
      cudaMemcpyAsync(env5_buffer, env5Ptr, Task.getBytesizeEnv5(),
          cudaMemcpyHostToDevice, stream);
    }
    //env6
    if (env6Ptr) {
      if (oldSize_env6 < Task.getBytesizeEnv6()) {
        ...
        if (cudaMalloc(&env6_buffer, Task.getBytesizeEnv6()) != cudaSuccess)
          error("mapCUDA error while allocating memory on device (env6 "
                "buffer)\n");
        oldSize_env6 = Task.getBytesizeEnv6();
      }
      Task.setEnv6DevicePtr(env6_buffer);
      cudaMemcpyAsync(env6_buffer, env6Ptr, Task.getBytesizeEnv6(),
          cudaMemcpyHostToDevice, stream);
    }
    ...
    if ((void *)inPtr != (void *)outPtr) {
      if (oldSize_out < Task.getBytesizeOut()) {
        ...
        if (cudaMalloc(&out_buffer, padded_size * sizeof(Tout)) != cudaSuccess)
          error(
              "mapCUDA error while allocating memory on device (out buffer)\n");
        oldSize_out = Task.getBytesizeOut();

        //init kernels
        initCUDAKernel<Tout><<<blockcnt_r, thxblock_r, 0, stream>>>(
            out_buffer, (Tout)identityValue, padded_size);
      }
      Task.setOutDevicePtr(out_buffer);
    } else
      Task.setOutDevicePtr((Tout *)in_buffer);
    ...
    if (isPureMap()) {
      ...
      do {
        ...
        //CUDA Map
        mapCUDAKernel<TkernelMap, Tin, Tout, Tenv1, Tenv2, Tenv3, Tenv4, Tenv5,
            Tenv6><<<blockcnt, thxblock, 0, stream>>>(*kernelMap,
            Task.getInDevicePtr(), Task.getOutDevicePtr(),
            Task.getEnv1DevicePtr(), Task.getEnv2DevicePtr(),
            Task.getEnv3DevicePtr(), Task.getEnv4DevicePtr(),
            Task.getEnv5DevicePtr(), Task.getEnv6DevicePtr(), size);

        Task.afterMR(task ? task : (void *)oneShot);
      } while (Task.iterCondition(reduceVar, ++iter) && iter < maxIter);

      cudaMemcpyAsync(Task.getOutPtr(), Task.getOutDevicePtr(),
          Task.getBytesizeOut(), cudaMemcpyDeviceToHost, stream);
      ...
      if (cudaMalloc(&reduce_buffer, blockcnt_r * sizeof(Tout)) != cudaSuccess)
        error("mapCUDA error while allocating memory on device (reduce "
              "buffer)\n");
      ...
      if (isPureReduce()) {
        ...
        reduceCUDAKernel<TkernelReduce, Tout, Tenv1, Tenv2, Tenv3, Tenv4, Tenv5,
            Tenv6>
            <<<blockcnt_r, thxblock_r, thxblock_r * sizeof(Tout), stream>>>(
                *kernelReduce, reduce_buffer, (Tout *)Task.getInDevicePtr(),
                Task.getEnv1DevicePtr(), Task.getEnv2DevicePtr(),
                Task.getEnv3DevicePtr(), Task.getEnv4DevicePtr(),
                Task.getEnv5DevicePtr(), Task.getEnv6DevicePtr(), padded_size,
                thxblock_r, false, (Tout)identityValue);
        //copy reduce-blocks back to host
        cudaMemcpyAsync(reduceBlocksPtr, reduce_buffer,
            blockcnt_r * sizeof(Tout), cudaMemcpyDeviceToHost, stream);
        cudaStreamSynchronize(stream);
        ...
        for (size_t i = 0; i < blockcnt_r; ++i)
          reduceVar = hostReduce->K(reduceVar, reduceBlocksPtr[i],
              Task.getEnv1DevicePtr(), Task.getEnv2DevicePtr(),
              Task.getEnv3DevicePtr(), Task.getEnv4DevicePtr(),
              Task.getEnv5DevicePtr(), Task.getEnv6DevicePtr());
        ...
        do {
          ...
          //CUDA Map
          mapCUDAKernel<TkernelMap, Tin, Tout, Tenv1, Tenv2, Tenv3, Tenv4,
              Tenv5, Tenv6><<<blockcnt, thxblock, 0, stream>>>(*kernelMap,
              Task.getInDevicePtr(), Task.getOutDevicePtr(),
              Task.getEnv1DevicePtr(), Task.getEnv2DevicePtr(),
              Task.getEnv3DevicePtr(), Task.getEnv4DevicePtr(),
              Task.getEnv5DevicePtr(), Task.getEnv6DevicePtr(), size);
          ...
          //Reduce
          //CUDA: blockwise reduce
          reduceCUDAKernel<TkernelReduce, Tout, Tenv1, Tenv2, Tenv3, Tenv4,
              Tenv5, Tenv6>
              <<<blockcnt_r, thxblock_r, thxblock_r * sizeof(Tout), stream>>>(
                  *kernelReduce, reduce_buffer, Task.getOutDevicePtr(),
                  Task.getEnv1DevicePtr(), Task.getEnv2DevicePtr(),
                  Task.getEnv3DevicePtr(), Task.getEnv4DevicePtr(),
                  Task.getEnv5DevicePtr(), Task.getEnv6DevicePtr(), padded_size,
                  thxblock_r, false, (Tout)identityValue);
        ...
        cudaError err = cudaGetLastError();
        if (err != cudaSuccess)
          std::cerr << "Problem launching cudaMemcpyAsync (after kernel "
                       "calls), code = "
                    << err << " \n";
      }
...
private:
  ...
  size_t maxThreads;
  size_t maxBlocks;
  size_t oldSize_in, oldSize_out, oldSize_env1, oldSize_env2, oldSize_env3,
      oldSize_env4, oldSize_env5, oldSize_env6;
...
struct dummyMapF {
  __device__ typename taskT::Tout K(typename taskT::Tin,
      typename taskT::Tenv1 *, typename taskT::Tenv2 *, typename taskT::Tenv3 *,
      typename taskT::Tenv4 *, typename taskT::Tenv5 *,
      typename taskT::Tenv6 *) {
...
template <typename taskT>
struct dummyReduceF {
  __device__ typename taskT::Tout K(typename taskT::Tout a,
      typename taskT::Tout, typename taskT::Tenv1 *, typename taskT::Tenv2 *,
      typename taskT::Tenv3 *, typename taskT::Tenv4 *, typename taskT::Tenv5 *,
      typename taskT::Tenv6 *) {
    return a;
  }
};
...
struct dummyHostReduceF {
  typename taskT::Tout K(typename taskT::Tout a, typename taskT::Tout,
      typename taskT::Tenv1 *, typename taskT::Tenv2 *, typename taskT::Tenv3 *,
      typename taskT::Tenv4 *, typename taskT::Tenv5 *,
      typename taskT::Tenv6 *) {
    return a;
...
class ff_mapCUDA : public ff_stencilReduceCUDA<taskT, TkernelMap,
                       dummyReduceF<taskT>, dummyHostReduceF<taskT>> {
  bool isPureMap() { return true; }

public:
  ff_mapCUDA(size_t maxIter = 1)
      : ff_stencilReduceCUDA<taskT, TkernelMap, dummyReduceF<taskT>,
            dummyHostReduceF<taskT>>(maxIter) {}
  ff_mapCUDA(const taskT &task, size_t maxIter = 1)
      : ff_stencilReduceCUDA<taskT, TkernelMap, dummyReduceF<taskT>,
            dummyHostReduceF<taskT>>(task, maxIter) {}
};

template <typename taskT, typename TkernelReduce, typename ThostReduce>
class ff_reduceCUDA : public ff_stencilReduceCUDA<taskT, dummyMapF<taskT>,
                          TkernelReduce, ThostReduce> {
  bool isPureReduce() { return true; }

public:
  ff_reduceCUDA(size_t maxIter = 1)
      : ff_stencilReduceCUDA<taskT, dummyMapF<taskT>, TkernelReduce,
            ThostReduce>(maxIter) {}
  ff_reduceCUDA(const taskT &task, size_t maxIter = 1)
      : ff_stencilReduceCUDA<taskT, dummyMapF<taskT>, TkernelReduce,
            ThostReduce>(task, maxIter) {}
};
