 ...
 *
 *  \note MarcoA: Documentation written by a student. Should not be
 * considered reliable.
 */
/* ***************************************************************************
 *
...
public:
     ...
     * memory.
     *
     * \param **memptr pointer to a chunk of memory where the aligned memory will
     * be returned.
     * \param alignment the returned memory  will be a multiple of alignment,
