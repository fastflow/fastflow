...
#define _InterlockedCompareExchangePointer(destination, exchange, compare)     \
  _InterlockedCompareExchange(                                                 \
      (volatile long *)destination, (long)exchange, (long)compare)
#endif
...
#if ((defined __GNUC__ || defined __llvm__) && defined __unix__ &&             \
     defined __x86_64__)
#define ALIGN_SINGLE_POINTER 8
#define ALIGN_DOUBLE_POINTER 16
typedef unsigned long long int atom_t;
#elif ((defined __GNUC__ || defined __llvm__) && defined __unix__ &&           \
       defined __i686__)
typedef unsigned long int atom_t;
#define ALIGN_SINGLE_POINTER 4
#define ALIGN_DOUBLE_POINTER 8
#elif ((defined __GNUC__ || defined __llvm__) && defined __unix__ &&           \
       (defined __arm__ ||                                                     \
           defined __aarch64__)) // need to distinghuish 32 and 64 bit
typedef unsigned long int atom_t;
#define ALIGN_SINGLE_POINTER 4
#define ALIGN_DOUBLE_POINTER 8
#elif ((defined __GNUC__ || defined __llvm__) && defined __unix__ &&           \
