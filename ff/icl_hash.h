...
static inline icl_hash_t *icl_hash_create(int nbuckets,
    unsigned int (*hash_function)(void *),
    int (*hash_key_compare)(void *, void *)) {
  icl_hash_t *ht;
  int i;
...
static inline void *icl_hash_find(icl_hash_t *ht, void *key) {
  icl_entry_t *curr;
...
static inline icl_entry_t *icl_hash_insert(
    icl_hash_t *ht, void *key, void *data) {
  icl_entry_t *curr;
  unsigned int hash_val;
...
static inline icl_entry_t *icl_hash_update_insert(
    icl_hash_t *ht, void *key, void *data) //, void **olddata)
{
  ...
  for (prev = NULL, curr = ht->buckets[hash_val]; curr != NULL;
 ...
 */
static inline int icl_hash_delete(icl_hash_t *ht, void *key,
 ...
 * @returns 0 on success, -1 on failure.
 */
static inline int icl_hash_destroy(
    icl_hash_t *ht, void (*free_key)(void *), void (*free_data)(void *)) {
