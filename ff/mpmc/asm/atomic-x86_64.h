 ...
 */
static __inline__ unsigned long atomic64_add_return(
    unsigned long i, atomic64_t *v) {
  unsigned long __i = i;
...
static __inline__ unsigned long atomic64_sub_return(
    unsigned long i, atomic64_t *v) {
...
static __inline__ unsigned long cmpxchg8(
 ...
 */
static inline unsigned long atomic64_add_unless(
    atomic64_t *v, unsigned long a, unsigned long u) {
  unsigned long c, old;
  c = atomic64_read(v);
  for (;;) {
