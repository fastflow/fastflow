...
static __inline__ int atomic_add_return(int a, atomic_t *v) {
  ...
  __asm__ __volatile__(LWSYNC_ON_SMP "1:	lwarx	%0,0,%2	\n\
...
static __inline__ int atomic_dec_return(atomic_t *v) {
  ...
  __asm__ __volatile__(LWSYNC_ON_SMP "1:	lwarx	%0,0,%1	\n\
...
static __inline__ unsigned long __cmpxchg_u32(
    volatile unsigned int *p, unsigned long old, unsigned long _new) {
  unsigned int prev;
...
static __inline__ long atomic64_add_return(long a, atomic64_t *v) {
  ...
  __asm__ __volatile__(LWSYNC_ON_SMP "1:	ldarx	%0,0,%2	\n\
	add	%0,%1,%0\n\
	stdcx.	%0,0,%2 \n\
	bne-	1b" ISYNC_ON_SMP
                       : "=&r"(t)
...
static __inline__ long atomic64_inc_return(atomic64_t *v) {
  ...
  __asm__ __volatile__(LWSYNC_ON_SMP "1:	ldarx	%0,0,%1	\n\
	addic	%0,%0,1\n\
	stdcx.	%0,0,%1 \n\
	bne-	1b" ISYNC_ON_SMP
                       : "=&r"(t)
...
static __inline__ unsigned long __cmpxchg_u64(
    volatile unsigned long *p, unsigned long old, unsigned long _new) {
  unsigned long prev;
